...
;(require 'org-mode)
(setq org-directory "/Users/CSmith/GoogleDrive/Org/"
...
(let ((org-super-agenda-groups
  ...
  (org-agenda nil "a"))
#+END_SRC
This pulls up my agenda after I am inactive for 5 min while working in emacs.
...
(defun bnb/idle-agenda (&optional arg)
  ...
  (setq bnb/iagenda
        (if arg
          ...
          (run-with-idle-timer 360 t 'bnb/jump-to-org-agenda))))
